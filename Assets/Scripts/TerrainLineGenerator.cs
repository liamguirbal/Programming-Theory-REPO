...
public class TerrainLineGenerator : MonoBehaviour
{
    ...
    void GenerateTerrain()
    {
        ...
        // La route gère ses propres voitures via son spawner intégré
    ...
    void SpawnDecorations()
    {
        ...
        for (int i = 0; i < decorationCount; i++)
        {
            ...
            {
                // Position complètement aléatoire (organique !)
                ...
                // Variation d'échelle pour effet naturel
                if (randomizeScale)
                {
